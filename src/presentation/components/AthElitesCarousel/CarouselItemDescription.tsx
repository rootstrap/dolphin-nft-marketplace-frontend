  ...
  return (
    <div className={styles.carousel__description}>
      <div className={styles.carousel__descriptionFeatured}>
        <Typography variant="h6">{t('athElites.carousel.featured')}</Typography>
      </div>
      ...
      <div className={styles.carousel__descriptionCheckout}>
        <Typography variant="body1">
          <Link>{t('athElites.carousel.link')}</Link>
        </Typography>
      </div>

      <div className={styles.carousel__descriptionPack}>
        <div className={styles.carousel__descriptionPackInfo}>
          <Typography variant="h6">{t('athElites.carousel.collectibles')}</Typography>
          <p>{collectiblesPerPack}</p>
        </div>
        <div className={styles.carousel__descriptionPackInfo}>
          <Typography variant="h6">{t('athElites.carousel.cost')}</Typography>
          <p>${costPerPack}</p>
        </div>
      </div>
