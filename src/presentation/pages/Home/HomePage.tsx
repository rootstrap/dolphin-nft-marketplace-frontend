						...
						<div className={styles.homePage__latestSection}>
							<Grid container spacing={2}>
								<Grid item xs={12} md={8} lg={4}>
									<Typography
										variant='h6'
										className={styles.homePage__latestSectionText}
									>
						...
						<div className={styles.homePage__searchBar}>
							<Grid container spacing={2}>
								<Grid item md={7}>
									<TextField
										variant='outlined'
										placeholder='Search your next NFT'
										fullWidth
									/>
								</Grid>
								<Grid item md={1}>
						...
						<div className={styles.homePage__categorySection}>
							<Grid container spacing={2}>
								<Grid item xs={6} md={8} lg={6}>
									<Typography
										variant='h6'
										className={styles.homePage__categorySectionText}
									>
										{t('home.categorySection.title')}
									</Typography>
									<Typography
										className={styles.homePage__categorySectionDescription}
									>
