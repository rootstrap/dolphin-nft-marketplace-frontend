...
import { DepositModal } from 'app/components/DepositModal/DepositModal';
import { BuyModal } from 'app/components/BuyModal/BuyModal';
      ...
      <Grid item xs={8} md={12} lg={5}>
        <div className={styles.buyContent__itemFund}>
          ...
          <div className={styles.buyContent__buttonContainer}>
            ...
            <Button fullWidth variant="contained" disabled={!enoughBalance} onClick={handleOpenBuyNftModal}>
              {t('nft.buyButton')}
            </Button>
