import { useGoogleLoginMutation, useLoginStatusMutation } from 'infrastructure/services/user/UserService';
...
export const LoginGoogle = () => {
  ...
  const clientId = '609589786870-8adupdv7qpnaiagudd9uikek8ina8872.apps.googleusercontent.com'; // PROD
